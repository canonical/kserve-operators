...
class KServeLLMISVCCharm(CharmBase):
    ...
    def __init__(self, *args):
        ...
        controller_metrics_port = ServicePort(
            port=METRICS_PORT, targetPort=METRICS_PORT, name=f"{self.app.name}-metrics"
        )
        aggregated_metrics_port = ServicePort(
            port=METRICS_PROXY_PORT,
            targetPort=METRICS_PROXY_PORT,
            name=f"{self.app.name}-aggregated-metrics",
        )
        self.service_patcher = KubernetesServicePatch(
            self,
            [controller_metrics_port, aggregated_metrics_port],
