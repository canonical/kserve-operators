...
This document outlines the processes and practices recommended for contributing enhancements to `kserve-controller`.
...
To build `kserve-controller` run:
...
# Deploy the charm
juju deploy ./kserve-controller_ubuntu@24.04-amd64.charm --trust \
